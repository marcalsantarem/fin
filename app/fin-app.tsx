...
type ThemeId = "classic" | "atelier" | "pulse";
type ColorMode = "light" | "dark" | "system";

const themeIds: ThemeId[] = ["classic", "atelier", "pulse"];
